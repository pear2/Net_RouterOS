...
abstract class Persistent extends Connection
{
    ...
    public function testTaglessModePassing()
    {
        ...
        $response1_1 = new Response($com1, null, null, null, $reg1);
        ...
        $response2_1 = new Response($com2, null, null, null, $reg2);
        $response2_2 = new Response($com2, null, null, null, $reg2);
        $response2_3 = new Response($com2, null, null, null, $reg2);
        ...
        $response1_2 = new Response($com1, null, null, null, $reg1);
        $response1_3 = new Response($com1, null, null, null, $reg1);
